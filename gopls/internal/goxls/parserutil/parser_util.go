...
func GetClassType(file *ast.File, filename string, getMod func() (*gopmod.Module, error)) (classType string, isTest bool, ok bool, err error) {
	...
	classType, isTest, ok = gop.GetFileClassType(mod, file, filename)
	return
}
