...
func GopSignatureHelp(ctx context.Context, snapshot Snapshot, fh FileHandle, position protocol.Position) (*protocol.SignatureInformation, int, error) {
...
FindCall:
	...
	case *ast.Ident:
		obj = pkg.GopTypesInfo().ObjectOf(t)
	case *ast.SelectorExpr:
		obj = pkg.GopTypesInfo().ObjectOf(t.Sel)
	}
...
func gopBuiltinSignature(ctx context.Context, snapshot Snapshot, callExpr *ast.CallExpr, name string, pos token.Pos) (*protocol.SignatureInformation, int, error) {
